...
cascade_dir = os.path.join(os.path.dirname(cv2._file_), "data", "haarcascade_frontalface_default.xml")
face_classifier = cv2.CascadeClassifier(cascade_dir)

video_path = '/home/dharithri/indecommSmartAttendance/backend/ml/test/Athul.mp4'
